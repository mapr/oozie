...
public class TestHiveServer2ActionExecutor extends ActionExecutorTestCase {
    ...
    protected void setSystemProps() throws Exception {
        ...
        setSystemProperty("oozie.service.ActionService.executor.classes", HiveServer2ActionExecutor.class.getName());
    }
    ...
    public void testSetupMethods() throws Exception {
        ...
        classes.add(HiveServer2Main.class);
        assertEquals(classes, ae.getLauncherClasses());

        Element actionXml = XmlUtils.parseXml("<hiveserver2>" +
        ...
        WorkflowJobBean wf = createBaseWorkflow(protoConf, "hiveserver2-action");
        ...
        assertEquals("jdbc:hive2://foo:1234/bar", conf.get("oozie.hiveserver2.jdbc.url"));
        assertEquals("pass", conf.get("oozie.hiveserver2.password"));
        assertEquals("script.q", conf.get("oozie.hiveserver2.script"));
        assertEquals("2", conf.get("oozie.hiveserver2.params.size"));
        assertEquals("a=A", conf.get("oozie.hiveserver2.params.0"));
        assertEquals("b=B", conf.get("oozie.hiveserver2.params.1"));
        assertEquals("2", conf.get("oozie.hiveserver2.args.size"));
        assertEquals("-c", conf.get("oozie.hiveserver2.args.0"));
        assertEquals("--dee", conf.get("oozie.hiveserver2.args.1"));
    }
    ...
    private String getActionXml() {
        String script = "<hiveserver2 xmlns=''uri:oozie:hiveserver2-action:0.1''>" +
...
/*
    ...
    private RunningJob submitAction(Context context) throws Exception {
        ...
        Namespace ns = Namespace.getNamespace("uri:oozie:hiveserver2-action:0.1");
        XConfiguration conf =
